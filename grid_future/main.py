...
time_sequence = [5]  # Rebalancing Time Sequence (เวลาที่จะใช้ในการ Rebalance ใส่เป็นเวลาเดี่ยว หรือชุดตัวเลขก็ได้)
time_multiplier = 1
...
while True:
    try:
        ...
        while asset_value < 0.01 and free_col > 0:
        ...
        while asset_value > 1 and free_col > 0:
            ...
            for t in time_sequence:
                ...
                print('Your {} size is {}'.format(token_name, asset_size))
                ...
                if asset_size < fix_asset_control and price < last_trade_price - step:
                    print("Current {} size less than fix size : Rebalancing -- Buy".format(token_name))
                    ...
                    print("Current {} size more than fix size : Rebalancing -- Sell".format(token_name))
